...
import com.jovanovic.stefan.sqlitetutorial.GroceryContract.*;
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_TYPE = "list_type";
    private static final String COLUMN_COLOR = "list_color";
   public  MyDatabaseHelper(@Nullable Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
      ...
      String SQL_CREATE_GROCERYLIST_TABLE = "CREATE TABLE " +
                ...
                GroceryEntry.COLUMN_LIST_ID + " INTEGER);";
    ...
    void addBook(String title, String type, String color){
    ...
    void updateData(String row_id, String title, String type, String color){
